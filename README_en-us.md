...
7. [Future Updates](#7-future-updates)
    ...
    - [CloudFormation Full Coverage] #TODO
...
Where te columns can be further described as: 
...
- [Configure Sagemaker Domain.](#SagemakerDomain).
    ...
    - Take note of the `Default execution role` ARN, and write it to the `.env`.
    - Take note of the S3 bucket name and write it to the `.env`. Otherwise, any bucket can be used.
...
- **RDS_SECRET_NAME:** Secret name from AWS Secret Manager to access RDS MySQL database.
